...
const FEATURES = [
  { icon: <CheckSquare size={24} />, title: 'Smart Task Management', desc: 'Priorities, subtasks, dependencies — organized your way' },
  { icon: <Calendar size={24} />, title: 'Calendar Integration', desc: 'See your day, week, or month at a glance' },
  { icon: <Layers size={24} />, title: 'Life Zones', desc: 'Balance work, health, relationships, and more' },
  { icon: <Zap size={24} />, title: 'Focus Sessions', desc: 'Deep work mode with ambient sounds' },
  { icon: <Shield size={24} />, title: 'Offline First', desc: 'Works without internet, syncs when back online' },
  { icon: <Smartphone size={24} />, title: 'PWA Ready', desc: 'Install on any device, native feel' },
];
...
export function Landing() {
  ...
  return (
    <div style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ padding: 'var(--space-12) var(--space-6)', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 'var(--space-6)', maxWidth: 800, margin: '0 auto', width: '100%' }}>
        {FEATURES.map(f => (
