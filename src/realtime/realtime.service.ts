...
export class RealtimeService {
  ...
  broadcastTaskCreated(userId: string, zoneId: string | null, taskData: any): void {
  ...
  broadcastTaskUpdated(userId: string, zoneId: string | null, changes: any, updatedBy: string): void {
  ...
  broadcastTaskDeleted(userId: string, zoneId: string | null, taskId: string, deletedBy: string): void {
  ...
  broadcastZoneUpdated(userId: string, zoneId: string, changes: any, updatedBy: string): void {
    this.broadcastToUser(userId, 'zone:updated', { zoneId, changes, updatedBy });
    this.broadcastToZone(zoneId, 'zone:updated', { zoneId, changes, updatedBy });
  }

  broadcastZoneDeleted(userId: string, zoneId: string, deletedBy: string): void {
  ...
  broadcastZoneMemberRoleChanged(zoneId: string, userId: string, oldRole: string, newRole: string): void {
    this.broadcastToZone(zoneId, 'zone:member:role-changed', { zoneId, userId, oldRole, newRole });
  }
