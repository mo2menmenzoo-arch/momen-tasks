...
export class CryptoUtil {
  ...
  static encrypt(plaintext: string): string {
    ...
    const derivedKey = scryptSync(key.toString('hex'), salt.toString('hex'), KEY_LENGTH);
  ...
  static decrypt(ciphertext: string): string {
    ...
    try {
      ...
      const derivedKey = scryptSync(this.getKey().toString('hex'), salt.toString('hex'), KEY_LENGTH);
